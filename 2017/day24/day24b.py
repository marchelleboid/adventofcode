...
def build_bridges(port_needed, existing_strength, existing_length, components_left):
    ...
    for component in components_possible:
        ...
        build_bridges(next_port_needed, new_strength, new_length, components_left_copy)


build_bridges(0, 0, 0, components)
