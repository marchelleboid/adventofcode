...
public class Day13A : ISolver
{
    ...
    public void Solve()
    {
        ...
        foreach (var line in lines)
        {
            ...
            else if (line.Length != 0)
            {
                ...
                var prizeX = double.Parse(match.Groups[1].Value);
                var prizeY = double.Parse(match.Groups[2].Value);
    ...
    private static int SolveEquation(double x1, double y1, double x2, double y2, double prizeX, double prizeY)
    {
