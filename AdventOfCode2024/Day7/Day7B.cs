    ...
    public void Solve()
    {
        ...
        foreach (var line in lines)
        {
            ...
            while (queue.Count > 0)
            {
                ...
                var concatenation = long.Parse(first.ToString() + second.ToString());
                ...
                if (concatenation <= goal)
                {
                    queue.Enqueue(new List<long> { concatenation }.Concat(current).ToList());
                }
            }
        }
